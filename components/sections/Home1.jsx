        ...
        <div className="container position-relative z-3">
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <span className="text-dark">👋 Hi there, we're mbit.devs</span>
              <h1 className="ds-2 mb-3">
              Crafting Scalable{" "}
                <span className="text-primary">Web & App Solutions</span>
              </h1>
              <p className="text-300 mb-6">
                We are a team of developers and designers focused on delivering
                tailored digital products that combine strategy, technology, and
                creativity.
              </p>
              <Link
